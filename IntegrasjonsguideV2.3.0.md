...
Pasientinitert bestilling av skjema er en mulighet hvor pasienten kan gå via en direktelink for utfylling av et skjema. Dersom et skjema skal være pasientinitiert må:
* Bestillersystemet være satt opp med en kryptert forbindelse
* Skjema må være publisert og "Kan bestilles av pasient" være markert

Det er mulig å velge om man ønsker at skjema bestilt av pasient må signeres. Url blir tilgjengelig etter man har lagret skjema.
